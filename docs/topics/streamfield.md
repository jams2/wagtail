...
For more information on how `StreamField` interacts with Django's migration system, and a guide to migrating rich text to `StreamFields`, see the [StreamField migrations page](streamfield_migrations).
